                ...
                if (mysqli_query($db, $query)){
                    ...
                    if (mysqli_num_rows($check)!=1){
                        ...
                        mysqli_query($db, $sql);
                            ...
                            $mail->Body = 'Dear '.$fname.'<br><br>Your temporary account for <a href="gsck.online">Goldenstate College of Koronadal Appointment System</a> is ready to use.
                    ...
                    <div class="list_group_container">    
                        ...
                        <form action="Staff/registrar/updatedelete_studentrecord.php" method="post">
                            ...
                            <div class="btn_group" role="group" aria-label="Basic example">
                                ...
                                <button type="button" onclick="del(this);" value="<?php echo $row['student_id']; ?>">DELETE</button>
                            </div>
...
<div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div>
          <form method="POST" id="form_delete" action="Staff/registrar/updatedelete_studentrecord.php">
