                            ...
                            while($rows=mysqli_fetch_assoc($acceptedrequest_result)) {?> 
                                ...
                                <div id="confirmModal" class="modal">
                                        ...
                                        <div>
                                            ...
                                            <button class="submit" type="submit" id= "cancel" name="cancel" onclick="location.href='appointment/unifast_done.php?appointment_id=<?php echo $rows['appointment_id']; ?>'" >Confirm</button>
