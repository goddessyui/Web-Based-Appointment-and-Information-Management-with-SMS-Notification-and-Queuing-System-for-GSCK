...
if(isset($_POST["view"]))
{
//  $id = !empty($_SESSION["staff_id"])?$_SESSION["staff_id"]:$_SESSION["student_id"];
 ...
 $query = "SELECT * FROM tbl_notification WHERE id = {$_POST["id"]} ORDER BY notification_id DESC LIMIT 5";
