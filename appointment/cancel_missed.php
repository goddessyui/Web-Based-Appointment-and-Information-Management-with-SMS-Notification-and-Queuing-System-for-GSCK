...
if (mysqli_query($db, $cancelappointment)) {
   ...
   header('location: ../staff_missed_requests.php?success="Appointment Cancelled"');
  
} else {
   header('location: ../staff_missed_requests.php?error="<?php echo "ERROR: Not able to execute. " . mysqli_error($db);?>"');
}
mysqli_close($db);
