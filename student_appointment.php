...
<div class="parent-div"><!-----start of parent div------------------------------------------------------->
    ...
    <div><!-- This starts the form to insert into tbl_appointment through student_insert_appointment.php -->
        <?php
            //get data
            if(isset($_POST['appointmenttype'])) { 
        ?>  
            <div class="at-modal"><!------------ Modal ------------------->
        ...
        ?>
    </div><!-- This ends the form to insert into tbl_appointment through student_insert_appointment.php -->
