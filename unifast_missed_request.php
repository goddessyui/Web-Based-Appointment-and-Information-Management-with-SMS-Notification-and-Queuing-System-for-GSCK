                        ...
                        if($count>0) {
                            ...
                            while($rows=mysqli_fetch_assoc($missedrequest_result)) { ?>
                                ...
                                <div class="row_app">
                                    ...
                                    <div class="col_app">
                                        <!-------------------------To reschedule appointment. Send Form Data to unifast_reschedule_missed.php --------------------------->       
                                        <form action="appointment/unifast_reschedule_missed.php?appointment_id=<?=$rows['appointment_id']?>" method="post">
                                        ...
                                        <!-------------------------Send Form Data to unifast_reschedule_missed.php ------------------------------>   
                                    </div>  

                                    <div class="col_app">
                                        <!-------------------------To Cancel Appointment and add note. Send Form Data to cancel.php ---------------------->  
                                        <form action ="appointment/unifast_cancel_missed.php?appointment_id=<?=$rows['appointment_id']?>"  method="post">
                                    ...
                                    <div class="col_app">
                                        ...
                                        <div>
                                            <button type="submit" id="done"><a href="appointment/unifast_done_missed.php?appointment_id=<?php echo $rows['appointment_id']; ?>">
                                            DONE</a>
                                            </button>
                                        </div>
                                        <!-------------------------Send data to done.php ------------------------------> 
